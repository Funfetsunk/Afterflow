...
|---|---|---|---|
| 2026-09-21 → 2026-10-21 | Tier 1 (Pixel Apprentice) | 163 | 859 of 2,000 were already used this cycle before Afterflow started; 1,140 left on 2026-09-25; 1,000 left after north-star round 1; 990 after 16px grass-path; 981 after the 16px river; 977 after Awa v2 |
...
| `obj_trees` | Meadow trees (oak, birch), 16-bit | ~32–48px | — | — | — | — | planned | Style reference: the north star |
